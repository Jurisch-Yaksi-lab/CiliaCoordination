...
SourceP = 'C:\Users\Bonnie\OneDrive - NTNU\Github\03-02-2017_0_0_aligned.mat'; 
CBF.name = '03-02-2017_0_0_aligned'; % Give a name
load(SourceP); 
data = double(aligned); 

% Define the target path 
CBF.targetP = 'C:\Users\Bonnie\OneDrive - NTNU\Github\03-02-2017_0_0_aligned\';
mkdir(CBF.targetP)
cd(CBF.targetP); 
...
CBF.signal_size = 500; % minimum number of pixels to be considered signal
...
[CBF] = cr_patchwise_analysisV4(phase_patch, pos, PowerSpec, check, CBF); 
