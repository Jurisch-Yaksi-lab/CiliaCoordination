function [] = cr_coherence_all(data, Pxx, CBF)
...
saveas(gcf, [CBF.targetP,CBF.name, '_figure_distance_matrix.png']);
...
save([CBF.targetP, CBF.name, '_result_coherence_versus_distance.mat'], 'Vcoh', 'Dist');
saveas(gcf, [CBF.targetP,CBF.name, '_figure_coherence_vs_distance.png']);
