...
for iPatch = 1:CBF.NumPatches
    ...
    % Skip the patch if it is empty and throw an error
    if length(lmatrix(lmatrix == iPatch)) > CBF.minsize
        ...
        sprintf('This patch (%i) was engulfed by a bigger patch. Your image may be too patchy', iPatch)
    end
end
