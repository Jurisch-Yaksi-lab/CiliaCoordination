function [CBF] = cr_patchwise_analysisV4(phase_patch, pos, PowerSpec, check, CBF)
...
[xfield, yfield, theta_all, phase_pd, phase_sd, mean_phases, cv_phases] = wave_direction(lmatrix);  %#ok<ASGLU>
...
%% Nested functions
    function [xfield, yfield, theta_all, phase_pd, phase_sd, mean_phases, cv_phases] = wave_direction(lmatrix)
